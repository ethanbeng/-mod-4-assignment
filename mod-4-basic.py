...
def savings(gross_pay, tax_rate, expenses):
    ...
    gross_pay=gross_pay*(1-tax_rate)
    gross_pay=math.floor(gross_pay)
    gross_pay-=expenses
    return gross_pay
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    final_material=total_material-material_consumed
...
def body_mass_index(weight, height):
    ...
    weight=(weight*0.453592)/(((([0]*12)+height[1])/39.3701)**2)